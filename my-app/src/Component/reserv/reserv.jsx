...
export default function Reserv() {
  return (
    <>
            ...
            <button class="butreserv" id="bronirovan">Booking</button>
        </div>
        <div class="text">
            ...
            <div class="buttontext">
                <button class="butreserv" id="bronirov">Booking</button>
                <button class="butreserv" id="dostavka">Delivery</button>
            </div>
        </div>
        </>
  );
